...
## Project Structure
    ...
    ├── testapiautoconnect_114752  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_114752`
...
2. Clone this repo and `cd testapiautoconnect_114752`
